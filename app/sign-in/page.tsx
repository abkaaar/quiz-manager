...
<div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-white p-4">
      <div className="w-full max-w-md">
        {/* Glass effect card */}
        <div className="bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl shadow-xl overflow-hidden border border-white border-opacity-30">
          <div className="px-8 py-10">
            <div className="flex flex-col items-center mb-10">
              {/* Your logo can go here */}
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mb-4">
                <Brain className='text-white h-18 w-18' />
              </div>
            ...
            <div className="space-y-6">
              <Button
                ...
                disabled={loading}
                className="w-full py-6 flex items-center justify-center space-x-3 bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 shadow-sm transition-all duration-200 transform hover:scale-105"
              >
                {loading ? (
